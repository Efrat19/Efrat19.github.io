...
- **CI Pipelines:** ​gitlabCI, CircleCI, GitHubActions. also worked with Jenkins. Infrastructure as Code: ​Terraform, CloudFormation
- **Security - WAF & antibot Services​:** StackPath, Fireblade, Radware.
...
- **Back End:** ​php5.6/ 7.3 + Laravel5, nodeJS11, Go. SQL.
- **AWS Cloud Services:** ​EKS, RDS, EC2, ELB, VPC, S3, ElasticCache, IAM, DocumentDB, Route53, EFS, SES.
